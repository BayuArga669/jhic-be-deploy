          ...
          <div :class="sidebarToggle ? 'justify-center' : 'justify-between'"
              ...
              <a href="{{ route('dashboard') }}">
                  <span class="logo" :class="sidebarToggle ? 'hidden' : ''">
                      <img class="dark:hidden  w-44 h-auto" src="{{ secure_asset('storage/image/logo_embed.png') }}"
                          alt="Logo" />
                      <img class="hidden dark:block w-44 h-auto" src="{{ secure_asset('storage/image/logo_embed.png') }}"
                          alt="Logo" />
                  </span>

                  <img class="logo-icon  w-44 h-auto" :class="sidebarToggle ? 'lg:block' : 'hidden'"
                      src="{{ secure_asset('storage/image/logo_embed.png') }}" alt="Logo" />
              </a>
          </div>
          <!-- SIDEBAR HEADER -->
