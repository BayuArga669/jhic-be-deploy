    ...
    <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        ...
        <div
            ...
            <a href="index.html" class="lg:hidden">
                <img class="dark:hidden w-36 h-auto" src="{{ secure_asset('storage/image/logo_embed.png') }}"
                    alt="Logo" />
                <img class="hidden dark:block w-36 h-auto" src="{{ secure_asset('storage/image/logo_embed.png') }}"
                    alt="Logo" />
            </a>
